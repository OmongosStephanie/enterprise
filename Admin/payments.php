...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['order_id'])) {
    ...
    $sql_update = "UPDATE orders 
                   SET status = '$status', 
                       delivered_date = " . ($delivered_date ? "'$delivered_date'" : "NULL") . ",
...
<div class="flex">
    ...
    <div class="w-64 bg-gray-800 text-white h-screen p-4">
        ...
        <ul>
            ...
            <li><a href="payments.php" class="text-lg py-2 block bg-gray-700 rounded">Payments</a></li>
...
<div class="flex-1 p-4">
    <div class="flex justify-between items-center bg-white p-3 rounded shadow mb-5 text-lg">
        ...
        <div class="text-gray-600">📅 <?php echo date("M d, Y"); ?> | 👤 Admin</div>
    </div>
