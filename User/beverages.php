...
// Count total beverages for pagination
$total_sql = "SELECT COUNT(*) as total FROM inventory WHERE category = 'Beverages'";
        ...
        <main class="container mx-auto py-6 px-4">
            ...
            <div class="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                <?php if ($result->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p class="text-center col-span-full text-gray-500">No beverages found.</p>
                <?php endif; ?>
            </div>
